...
class ImportTest(test_base.BaseTest):
  ...
  def test_long_from(self):
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("path/to/my_module.pyi"),
                    "def foo() -> str: ...")
      ty = self.Infer("""
  ...
  def test_dot_dot_packag_no_init(self):
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("baz/foo.py"), """
        from ..bar import x
      """)
      d.create_file("bar.pyi", """x = ...  # type: int""")
  ...
  def test_dot_dot_in_pyi(self):
    ...
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("foo/baz.pyi"), "x: int")
      d.create_file(file_utils.replace_seperator("foo/deep/bar.py"), """
        from .. import baz
        a = baz.x
      """)
  ...
  def test_from_dot_in_pyi(self):
    ...
    with file_utils.Tempdir() as d:
      ...
      d.create_file(file_utils.replace_seperator("foo/b.pyi"), """
        from . import a
        Y = a.X""")
      d.create_file("top.py", """
        import foo.b
  ...
  def test_subdir_and_module_with_same_name_as_package(self):
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("pkg/__init__.pyi"), """
          from pkg.pkg.pkg import *
          from pkg.bar import *""")
      d.create_file(file_utils.replace_seperator("pkg/pkg/pkg.pyi"), """
          class X: pass""")
  ...
  def test_get_bad_submodule_as_attribute(self):
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("foo/__init__.pyi"), "")
      d.create_file(file_utils.replace_seperator("foo/bar.pyi"), "nonsense")
      self.assertNoCrash(self.Check, """
        import foo
        x = foo.bar
      """, pythonpath=[d.path])
  ...
  def test_from_import(self):
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("foo/b.pyi"), """
        ...
        class bar(c.X): ...
      """)
      d.create_file(file_utils.replace_seperator("foo/c.pyi"), """
        class X: ...
      """)
      self.Check("""
        from foo import b
  ...
  def test_mutual_imports(self):
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("pkg/a.pyi"), """
      ...
      """)
      d.create_file(file_utils.replace_seperator("pkg/b.pyi"), """
  ...
  def test_module_reexports_and_aliases(self):
    with file_utils.Tempdir() as d:
      ...
      d.create_file(file_utils.replace_seperator("pkg/b.pyi"), """
        ...
        class e: ...
      """)
      d.create_file(file_utils.replace_seperator("pkg/d.pyi"), """
        class Y: ...
      """)
      d.create_file(file_utils.replace_seperator("pkg/g.pyi"), """
        class Z: ...
      """)
      ty = self.Infer("""
        import pkg.a
  ...
  def test_module_class_conflict(self):
    with file_utils.Tempdir() as d:
      d.create_file(file_utils.replace_seperator("foo/bar.pyi"), DEFAULT_PYI)
      ty = self.Infer("""
        from foo import bar
        class foo:
          def __new__(cls):
  ...
  def test_import_alias(self):
    with file_utils.Tempdir() as d:
      ...
      d.create_file(file_utils.replace_seperator("foo/bar.pyi"), """
        ...
        X = qux.X
      """)
      d.create_file(file_utils.replace_seperator("foo/baz.pyi"), "X = str")
